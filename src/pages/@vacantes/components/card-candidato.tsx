        ...
        <li key={index} className="list-none">
            ...
            >
                ...
                <ul className="flex flex-col mb-4 text-sm">
                    <p className="text-purple-600">{candidato.titulo}</p>
                    <p className="text-gray-400 flex items-center gap-1"><BookMarked className="size-4" /> {candidato.ultimo_grado_estudios}</p>
                    <p className="text-gray-400 flex items-center gap-1"><Calendar className="size-4" /> {candidato.fechaPublicacion}</p>
                </ul>
                <p className="text-gray-600 mb-4 flex-grow">
                    {candidato.descripcion}
                </p>
                <footer className="mt-auto flex gap-2">
                    <button className="border border-gray-200 p-2 rounded-lg hover:border-purple-800 font-medium text-sm">
                        Rechasar
                    </button>
